      ...
      {({ open }) => (
        <>
          ...
          <div className="mt-1 relative">
            <Listbox.Button className="relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-base-500 focus:border-base-500 sm:text-sm">
              ...
              >
                {people?.map((person) => (
                  <Listbox.Option
                    ...
                    className={({ active }) =>
                      classNames(
                        active ? 'text-white bg-base-600' : 'text-gray-900',
                    ...
                    {({ selected, active }) => (
                      <>
                        <div className="flex">
                          ...
                          <span className={classNames(active ? 'text-base-200' : 'text-gray-500', 'ml-2 truncate')}>
                            {person.username}
                          </span>
                        </div>
                        ...
                        {selected ? (
                          <span
                            className={classNames(
                              active ? 'text-white' : 'text-base-600',
