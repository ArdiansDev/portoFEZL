                      ...
                      <li key={person.handle}>
                        <div className="relative group py-6 px-5 flex items-center">
                          ...
                          <Menu as="div" className="ml-2 flex-shrink-0 relative inline-block text-left">
                            {({ open }) => (
                              <>
                                <Menu.Button className="group relative w-8 h-8 bg-white rounded-full inline-flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-base-500">
