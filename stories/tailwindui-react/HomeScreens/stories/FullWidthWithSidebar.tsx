...
const teams = [
  ...
  { name: 'Engineering', href: '#', bgColorClass: 'bg-base-500' },
            ...
            <div className="px-3 mt-5">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  name="search"
                  id="search"
                  className="focus:ring-base-500 focus:border-base-500 block w-full pl-9 sm:text-sm border-gray-300 rounded-md"
                  placeholder="Search"
                />
              </div>
            </div>
