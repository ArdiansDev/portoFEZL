...
export default function ModalLinks({ open, setOpen, data, onAddItem }) {
                ...
                <div className="mt-2 text-center sm:mt-0 sm:text-left">
                  ...
                  >
                    <p className="flex">
                      ...
                      You can add multiple existing links or create a new one.
                    </p>
                    <button onClick={() => router.push('/admin/link')}>
                      Create New Link →
                    </button>
                  </Dialog.Title>
