...
export default function RewardsInstructionRedeemed({
  Show,
  handleClose,
  rewardId,
  data,
  ...
  return (
    <div style={Show ? { display: 'block' } : { display: 'none' }}>
      ...
      ></div>
      <div className="bg-white  mobile:w-full items-center z-40 p-8 flex w-max h-max absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-8 ">
        <div
          onClick={handleClose}
