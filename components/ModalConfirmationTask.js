...
export default function ModalConfirmationTask({open, setOpen, type}) {
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure you want to withdraw your {type}?
                    </p>
                    <p className="text-sm text-gray-500">You will need to register again. This action cannot be undone.</p>
                  </div>
                </div>
              </div>
